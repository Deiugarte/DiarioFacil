   ...
   private static Scanner scan;
    ...
    public void agregarProveedor(List<Proveedor> proveedores) {
     ...
     public void editarProveedor( List<Proveedor> proveedores) {
        ...
        System.out.println("¿Qué quieres editar de " + proveedores.get(proveedor - 1).getNombreEmpresa() + "? " + "\n"
                + "1. Nombre de empresa" + "\n"
        ...
        switch (opcion) {
            ...
            case 1:
                ...
                System.out.println("El nombre de " + proveedores.get(proveedor - 1).getNombreEmpresa()
                        + " ha sido cambiado a " + nuevoNombre);
                proveedores.get(proveedor - 1).setNombreEmpresa(nuevoNombre);
                break;
            case 2:
                System.out.println("¿Cuál sería el nuevo representante?");
                String nuevoRepresentante = leer.nextLine();
                System.out.println("El representante de "+proveedores.get(proveedor-1).getNombreEmpresa()+
            ...
            case 3:
                ...
                String correo= leer.nextLine();
                 System.out.println("El correo de "+proveedores.get(proveedor-1).getNombreEmpresa()+
                        " ha sido actualizado a "+correo);
                 proveedores.get(proveedor-1).setCorreo(correo);
                 break;
                 
            case 4:
                System.out.println("¿Cuál sería el nuevo teléfono?");
                int telefono=scan.nextInt();
                System.out.println("El número de "+proveedores.get(proveedor-1).getNombreEmpresa()+
    ...
    public void eliminarProveedor(List<Proveedor> proveedores) {
        ...
        int opcion = scan.nextInt();
        System.out.println(proveedores.get(opcion - 1).getNombreEmpresa() + "Ha sido eiminado exitosamente!");
